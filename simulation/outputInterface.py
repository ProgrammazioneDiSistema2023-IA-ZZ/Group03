...
def computePerformance(currentIndex, updateInterval, countersEvolution,
    ...
    if currentIndex % updateInterval == 0 and currentIndex > 0:
        ...
        # Initialize the maximum count to 0 vec[0;100]
        maxCount = np.zeros(updateInterval)

        # Initialize the output classification vec[-1;100]
        ...
        for label in range(10):
            ...
            # Find where the spikes count is greater than the maximum; vec![false,false,true]
