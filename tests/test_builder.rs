...
fn test_add_weights_to_layers() {
    #[rustfmt::skip]
        ...
        .add_layer(vec![
            LifNeuron::new(0.3, 0.05, 0.1, 1.0,0.05),
            LifNeuron::new(0.3, 0.05, 0.1, 1.0,0.05)], vec![
            vec![0.1, 0.2, 0.3],
            vec![0.4, 0.5, 0.6]], vec![
            vec![0.0, -0.2],
            vec![-0.9, 0.0],
...
fn test_layer_with_one_neuron() {
    ...
    assert_eq!(verify_neuron(neuron.unwrap(), 0.12, 0.8, 0.03, 0.64,0.05), true);
}
...
fn test_neurons_with_same_parameters1() {
    #[rustfmt::skip]
        ...
        let snn_params = SnnBuilder::<LifNeuron,Conf>::new(5)
        .add_layer_with_same_neurons(LifNeuron::new(0.12, 0.8, 0.03, 0.64,0.05), 2, vec![
    ...
    assert_eq!(verify_neuron(neuron1.unwrap(), 0.12, 0.8, 0.03, 0.64,0.05), true);
    assert_eq!(verify_neuron(neuron2.unwrap(), 0.12, 0.8, 0.03, 0.64,0.05), true);
}
...
fn test_neurons_with_same_parameters2() {
    #[rustfmt::skip]
        ...
        let snn_params = SnnBuilder::<LifNeuron,Conf>::new(5)
        .add_layer(vec![
            LifNeuron::new(0.12, 0.8, 0.03, 0.64,0.05),
            LifNeuron::new(0.12, 0.8, 0.03, 0.64,0.05)], vec![
            vec![0.3, 0.5, 0.1, 0.6, 0.3],
            vec![0.2, 0.3, 0.1, 0.4, 0.2]], vec![
            vec![0.0, -0.3],
...
fn test_layer_with_more_than_one_neuron() {
    #[rustfmt::skip]
        ...
        let snn_params = SnnBuilder::<LifNeuron,Conf>::new(5)
        .add_layer(vec![
            LifNeuron::new(0.127, 0.46, 0.78, 0.67,0.05),
            LifNeuron::new(0.12, 0.22, 0.31, 0.47,0.05),
            LifNeuron::new(0.25, 0.36, 0.5, 0.84,0.05)], vec![
            vec![0.3, 0.5, 0.1, 0.6, 0.3],
    ...
    assert_eq!(neuron1.is_some(), true);
    assert_eq!(verify_neuron(neuron1.unwrap(), 0.127, 0.46, 0.78, 0.67,0.05), true);

    let neuron2 = layer_neurons1.unwrap().get(1);

    assert_eq!(neuron2.is_some(), true);
    assert_eq!(verify_neuron(neuron2.unwrap(), 0.12, 0.22, 0.31, 0.47,0.05), true);

    let neuron3 = layer_neurons1.unwrap().get(2);

    assert_eq!(neuron3.is_some(), true);
    assert_eq!(verify_neuron(neuron3.unwrap(), 0.25, 0.36, 0.5, 0.84,0.05), true);
}
...
fn test_intra_layer_weights_with_more_than_one_neuron() {
    #[rustfmt::skip]
        ...
        let snn_params = SnnBuilder::<LifNeuron,Conf>::new(5)
        .add_layer(vec![
            LifNeuron::new(0.127, 0.12, 0.78, 0.67,0.05),
            LifNeuron::new(0.12, 0.22, 0.31, 0.47,0.05),
...
fn test_complete_snn() {
    #[rustfmt::skip]
        ...
        .add_layer(vec![
            LifNeuron::new(0.1, 0.1, 0.23, 0.45,0.05),
            LifNeuron::new(0.3, 0.12, 0.54, 0.23,0.05),
            LifNeuron::new(0.2, 0.23, 0.23, 0.65,0.05),
            LifNeuron::new(0.4, 0.34, 0.12, 0.45,0.05)], vec![
    ...
    assert_eq!(verify_neuron(&neurons_layer1[0], 0.1, 0.1, 0.23, 0.45,0.05), true);
    assert_eq!(verify_neuron(&neurons_layer1[1], 0.3, 0.12, 0.54, 0.23,0.05), true);
    assert_eq!(verify_neuron(&neurons_layer1[2], 0.2, 0.23, 0.23, 0.65,0.05), true);
    assert_eq!(verify_neuron(&neurons_layer1[3], 0.4, 0.34, 0.12, 0.45,0.05), true);
    ...
    assert_eq!(verify_neuron(&neurons_layer2[0], 0.17, 0.12, 0.78, 0.67,0.05), true);
    assert_eq!(verify_neuron(&neurons_layer2[1], 0.25, 0.36, 0.71, 0.84,0.05), true);
    ...
    assert_eq!(snn.get_number_layers(), 2);
}
...
#[test]
#[should_panic]
fn test_snn_wrong_extra_weights1() {
    #[rustfmt::skip]
        /*
            Here the extra weights are wrong because the number of columns of the internal vec
             must be equal to the number of neurons of the previous layer
        */
        let _snn = SnnBuilder::<LifNeuron,Conf>::new(2)
        .add_layer(vec![
            LifNeuron::new(0.1, 0.05, 0.1, 1.0,0.05),
            LifNeuron::new(0.3, 0.23, 0.1, 0.89,0.05),
        ], vec![
            vec![0.2, 0.5],
            vec![0.3, 0.4],
        ], vec![
...
#[test]
#[should_panic]
fn test_snn_wrong_intra_weights1() {
    #[rustfmt::skip]
        /*
            Here the intra weights are wrong because the number of columns of the internal vec
             must be equal to the number of neurons of the current layer
        */
        let _snn = SnnBuilder::<LifNeuron,Conf>::new(2)
        .add_layer(vec![
            LifNeuron::new(0.1, 0.05, 0.1, 1.0,0.05),
...
#[test]
#[should_panic]
fn test_snn_wrong_extra_weights2() {
    #[rustfmt::skip]
        /*
             Here the extra weights are wrong because the number of rows of the extra weights vec
             must be equal to the number of neurons of the previous layer
         */
        let _snn = SnnBuilder::<LifNeuron,Conf>::new(2)
        .add_layer(vec![
...
#[test]
#[should_panic]
fn test_snn_wrong_intra_weights2() {
    #[rustfmt::skip]
        /*
            Here the intra weights are wrong because the number of rows of the internal vec
             must be equal to the number of neurons of the current layer
        */
        let _snn = SnnBuilder::<LifNeuron,Conf>::new(2)
        .add_layer(vec![
...
#[test]
#[should_panic]
fn test_snn_with_zero_layers() {
    #[rustfmt::skip]

        let _snn = SnnBuilder::<LifNeuron,Conf>::new(0).build();
}
